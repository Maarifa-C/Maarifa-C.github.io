...
//findout whenever you send a messages 
function log_click(click_target) {
  //checking the html code that was taken to see if you sent an message 
  ...
  if (dMatch) {
      ...
      if(dValue === str){
        ...
        //gets the messages you just sent
        function getMessage() {
...
//used to get the html of what your clicking on
